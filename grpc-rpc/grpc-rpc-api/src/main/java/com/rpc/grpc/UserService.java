...
public final class UserService {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.rpc.grpc.UserService.internal_static_ChatMessage_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.rpc.grpc.UserService.internal_static_ChatMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.rpc.grpc.UserService.ChatMessage.class, com.rpc.grpc.UserService.ChatMessage.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof com.rpc.grpc.UserService.ChatMessage)) {
        return super.equals(obj);
      }
      com.rpc.grpc.UserService.ChatMessage other = (com.rpc.grpc.UserService.ChatMessage) obj;

      if (!getContent()
          .equals(other.getContent())) return false;
      if (getCcId()
          != other.getCcId()) return false;
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + CCID_FIELD_NUMBER;
      hash = (53 * hash) + getCcId();
      hash = (29 * hash) + getUnknownFields().hashCode();
      memoizedHashCode = hash;
      return hash;
    }

    public static com.rpc.grpc.UserService.ChatMessage parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static com.rpc.grpc.UserService.ChatMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static com.rpc.grpc.UserService.ChatMessage parseFrom(
    ...
    public static com.rpc.grpc.UserService.ChatMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static com.rpc.grpc.UserService.ChatMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static com.rpc.grpc.UserService.ChatMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(com.rpc.grpc.UserService.ChatMessage prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        com.rpc.grpc.UserService.ChatMessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.rpc.grpc.UserService.internal_static_ChatMessage_descriptor;
      }
      ...
      // Construct using com.rpc.grpc.UserService.ChatMessage.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public com.rpc.grpc.UserService.ChatMessage getDefaultInstanceForType() {
        return com.rpc.grpc.UserService.ChatMessage.getDefaultInstance();
      }

      @java.lang.Override
      public com.rpc.grpc.UserService.ChatMessage build() {
        com.rpc.grpc.UserService.ChatMessage result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public com.rpc.grpc.UserService.ChatMessage buildPartial() {
        com.rpc.grpc.UserService.ChatMessage result = new com.rpc.grpc.UserService.ChatMessage(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(com.rpc.grpc.UserService.ChatMessage result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.rpc.grpc.UserService.ChatMessage) {
          return mergeFrom((com.rpc.grpc.UserService.ChatMessage)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.rpc.grpc.UserService.ChatMessage other) {
        if (other == com.rpc.grpc.UserService.ChatMessage.getDefaultInstance()) return this;
      ...
      /**
       * <code>int32 ccId = 2;</code>
       * @param value The ccId to set.
       * @return This builder for chaining.
       */
      public Builder setCcId(int value) {
    ...
    private static final com.rpc.grpc.UserService.ChatMessage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new com.rpc.grpc.UserService.ChatMessage();
    }

    public static com.rpc.grpc.UserService.ChatMessage getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tMessage\022\017\n\007content\030\001 \001(\t\022\014\n\004ccId\030\002 \001(\0052" +
      "=\n\014UserInfoChat\022-\n\tstartChat\022\014.ChatMessa" +
      "ge\032\014.ChatMessage\"\000(\0010\0012\276\001\n\017UserInfoServi" +
      "ce\022-\n\013getUserInfo\022\t.UserInfo\032\021.UserInfoR" +
      "esponse\"\000\022D\n getStreamingResponseWIthUse" +
      "rInfo\022\t.UserInfo\032\021.UserInfoResponse\"\0000\001\022" +
      "6\n\020batchGetUserInfo\022\t.UserInfo\032\021.UserInf" +
      "oResponse\"\000(\0010\001B\035\n\014com.rpc.grpcB\013UserSer" +
    ...
    internal_static_ChatMessage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ChatMessage_descriptor,
        new java.lang.String[] { "Content", "CcId", });
  }
